...
encolar y consultar estados; el worker, para registrar y ejecutar las tareas.
"""
...
celery_app.conf.update(
    ...
    # El worker toma UNA tarea por vez en lugar de pre-reservar un lote. 
    #si el worker muere, se traba una tarea, no varias.
    worker_prefetch_multiplier=1,

    # Los resultados en Redis expiran: Redis es estado vivo y efímero, la verdad
    # permanente es SQLite.
    result_expires=24 * 60 * 60,

    #  Con plazo, la espera devuelve una excepción: el trabajo queda FAILED,
    # el cliente recibe INTERNAL y el hilo vuelve al pool.
